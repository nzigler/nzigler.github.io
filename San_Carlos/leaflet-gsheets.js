      ...
      click: function(e) {
        ...
        document.getElementById("sidebar-content").innerHTML = "<TABLE>" +          
            ...
            if (e.target.feature.properties.Photo1) {
                return "<TR><TD colspan='2'> <a href='photos/" + e.target.feature.properties.Photo1 + "' target='_blank'><img src='photos/" + e.target.feature.properties.Photo1 + "' width='320'></a></TD></TR>"; 
            } +
            "</TABLE>";
