...
function init() {
  ...
  //var pointsURL = "https://docs.google.com/spreadsheets/d/1pv8BUL8xUzOHSrfJOT_NyuDgJ1WG4Yz0kKjMnHnT6DE/edit?usp=sharing";
    var pointsURL = "https://docs.google.com/spreadsheets/d/13Hr7s9Gx_a_Ejj6PabhKGqhUL-uArRZVZH0L70rqgbA/edit?usp=sharing";
...
// Create a new Leaflet map centered on Soledad
var map = L.map('map', {zoomControl:true, maxZoom:18, minZoom:1}).fitBounds([[36.45,-121.35],[36.41,-121.29]]);
...
abstract.show = function () {
    ...
    this._div.innerHTML = 'Soledad Development Review Map';
};
abstract.addTo(map);
